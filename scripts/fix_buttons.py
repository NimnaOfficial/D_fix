...
repl1 = r"""\1
        ...
        if (normalized.equals("COMPLETED") || normalized.equals("CANCELLED")) {
            if (btnMessages != null) btnMessages.setVisibility(android.view.View.GONE);
        } else {
            if (btnMessages != null) btnMessages.setVisibility(android.view.View.VISIBLE);
        }
"""
...
pattern2 = r"(updateStatusButton\(\s*status\s*\);)"
repl2 = r"""\1
